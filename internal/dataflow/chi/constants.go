...
import "github.com/Readm/flow_sim/internal/dataflow/message"

// CHI Channel types (mapped to generic Message channels)
const (
	CHIChannelREQ = message.ChannelREQ // Request channel
	CHIChannelRSP = message.ChannelRSP // Response channel
	CHIChannelDAT = message.ChannelDAT // Data channel
	CHIChannelSNP = message.ChannelSNP // Snoop channel
)
